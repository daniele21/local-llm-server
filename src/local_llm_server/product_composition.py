...
def install_product_http_stack(
    ...
    *,
    ...
    cold-state layer last. Identity is public/read-only and path-free; residency
    and policy evidence routes remain admin-only and expose bounded state rather
    than inference content or private paths.
    """
